    public static final JsonNode getJson(final ResultSet rs,final int index) throws SQLException, JsonProcessingException {
    ...
    public static final String convertJson(final JsonNode jsonNode) throws SQLException {

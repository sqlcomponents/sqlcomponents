...
<#if table.tableType == 'TABLE' >
    ...
    public static final class InsertStatement {
        ...
        public ValueClause values(final ${name} ${name?uncap_first}) {
            return new ValueClause(Arrays.asList(${name?uncap_first}),this);
        }

        public ValueClause values(final List<${name}> ${name?uncap_first}s) {
            return new ValueClause(${name?uncap_first}s,this);
        }
        public static final class ValueClause  {
            ...
            ValueClause (final List<${name}> ${name?uncap_first}s,final InsertStatement insertStatement) {

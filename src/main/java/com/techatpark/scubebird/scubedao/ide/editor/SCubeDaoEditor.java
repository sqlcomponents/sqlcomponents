...
import com.techatpark.scubebird.scubedao.ide.editor.navigator.DaoProjectNavigator;
import com.techatpark.scubebird.scubedao.model.DaoProject;
import com.techatpark.scubebird.scubedao.model.Entity;
import com.techatpark.scubebird.util.FileUtil;
import com.techatpark.scubebird.util.ScubeUtil;
...
public class SCubeDaoEditor extends AbstractSCubeDaoEditor implements
	...
	public void showProperties() {
		...
		request.setRequestParameter(RequestContants.PARAM_DAO_PROJECT_EDITOR,
				this);
		openModelDialog(
				"com.techatpark.scubebird.scubedao.ide.propertyeditor.IcgProjectScreen",
				request);

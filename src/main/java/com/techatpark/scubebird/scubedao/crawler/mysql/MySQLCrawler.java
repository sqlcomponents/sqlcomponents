package com.techatpark.scubebird.scubedao.crawler.mysql;

import com.techatpark.scubebird.exception.ScubeException;
import com.techatpark.scubebird.scubedao.crawler.Crawler;
import com.techatpark.scubebird.scubedao.crawler.mysql.enums.DataType;
import com.techatpark.scubebird.scubedao.crawler.mysql.enums.TableColumn;
import com.techatpark.scubebird.scubedao.crawler.mysql.enums.YesNo;
...
public class MySQLCrawler extends Crawler {
    ...
    public Schema getSchema(DaoProject project) throws ScubeException {
        ...
        schema.setPackages(new ArrayList<com.techatpark.scubebird.scubedao.model.Package>());
        return schema;
    }

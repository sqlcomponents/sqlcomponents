...
| `init.db/` | SQL seed scripts per engine (`postgres/`, `h2db/`, `sqlserver/`, …) for Docker or local DB setup. See [Stored procedures and functions](stored-procedures.md) for PostgreSQL `procedures.sql` and routine tests. |
